...
![langkah 1 praktikum 5](./images/langkah1_p5.png)
### Langkah 2: Mendefinisikan Route
Buatlah dua buah file dart dengan nama  `home_page.dart` dan `item_page.dart` pada folder pages. Untuk masing-masing file, deklarasikan `class HomePage` pada file `home_page.dart` dan `ItemPage` pada `item_page.dart`. Turunkan class dari `StatelessWidget`. Gambaran potongan kode dapat anda lihat sebagai berikut. 
![langkah 2 praktikum 5](./images/langkah2_p5.png)
...
![langkah 6 praktikum 5](./images/langkah6_p5.png)
...
![langkah 7 praktikum 5](./images/langkah7_p5.png)
![langkah 7 praktikum 5](./images/langkah(7)_p5.png)
